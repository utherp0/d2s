...
image::002-image002.png[Application Loading]

You know have an Application active on D2S. Click on the Roundel itself and the topology page should look very similar to this:
